<template><div><h1 id="tinh-truu-tuong-va-interface-muc-luc" tabindex="-1"><a class="header-anchor" href="#tinh-truu-tuong-va-interface-muc-luc" aria-hidden="true">#</a> Tính trừu tượng và Interface--------------------------------<a href="https://github.com/Zenfection/Java" target="_blank" rel="noopener noreferrer">Mục lục<ExternalLinkIcon/></a></h1>
...
<p>Từ khoá <code v-pre>abstract</code> là một <code v-pre>non-access modifier</code> bạn đã học trong bài <a href="https://github.com/Zenfection/Java/blob/master/Java%20OOP/2.Modifier.md" target="_blank" rel="noopener noreferrer">Phạm vi truy cập<ExternalLinkIcon/></a> , sử dụng cho <code v-pre>classes</code> và <code v-pre>methods</code> :</p>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
...
<h3 id="đe-truy-cap-vao-abstract-class-thi-ta-phai-lam-sao" tabindex="-1"><a class="header-anchor" href="#đe-truy-cap-vao-abstract-class-thi-ta-phai-lam-sao" aria-hidden="true">#</a> <img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/02/02-14-14-12-Language Learning.png" alt="Language Learningpng"> Để truy cập vào <code v-pre>abstract class</code>, thì ta phải làm sao ?</h3>
<details>
...
<br>
<p>Nó phải được kế thừa từ <code v-pre>class</code> khác. Hãy đổi lớp <code v-pre>Animal</code> mà ta sử udng5</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//khai báo lớp abstract</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//interface</span>
...
<p>🔥 Để truy cập vào <code v-pre>Interface Methods</code> ta phải dùng từ khoá <code v-pre>implements</code> (<em>thay vì sử dụng <code v-pre>extends</code></em>) như sau :</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> <span class="token class-name">Animal</span><span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">animalSound</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>🧨 Tính chất của <code v-pre>Interface</code> :</p>
<ul>
...
<h3 id="tai-sao-ta-phai-su-dung-interface" tabindex="-1"><a class="header-anchor" href="#tai-sao-ta-phai-su-dung-interface" aria-hidden="true">#</a> <img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/02/02-14-14-12-Language Learning.png" alt="Language Learningpng"> Tại sao ta phải sử dụng <code v-pre>Interface</code> ?</h3>
<details>
<summary><b><img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/02/01-13-25-05-Questions And Answers.png"> Trả lời</summary>
<br>
<ul>
<li>Để được sử bảo mật an toàn.</li>
<li><code v-pre>Java</code> không hỗ trợ <code v-pre>multiple inheritance</code> (<em>đa kế thừa</em>) - tức là một <code v-pre>class</code> có thể kế thừa từ một <code v-pre>subclass</code> ==&gt; Tuy nhiên ta có thể làm được điều đó bằng cách sử dụng <code v-pre>Interface</code></li>
</ul>
<blockquote>
...
<br>
<h3 id="o-tren-noi-co-the-dung-interface-đe-đa-ke-thua-vay-dung-sao" tabindex="-1"><a class="header-anchor" href="#o-tren-noi-co-the-dung-interface-đe-đa-ke-thua-vay-dung-sao" aria-hidden="true">#</a> <img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/02/02-14-14-12-Language Learning.png" alt="Language Learningpng"> Ở trên nói có thể dùng <code v-pre>Interface</code> để đa kế thừa, vậy dùng sao ?</h3>
<details>
<summary><b><img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/02/01-13-25-05-Questions And Answers.png"> Trả lời</summary>
<br>
<p>Ta sử dụng từ khoá <code v-pre>implement</code> đến nhiều <code v-pre>Interface</code> cách nhau bởi dấu <code v-pre>;</code> như sau :</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> <span class="token function">firstInterface</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<thead>
<tr>
<th>🔙  <a href="https://github.com/Zenfection/Java/blob/master/Java%20OOP/4.Inheritance%26Polymorphism.md" target="_blank" rel="noopener noreferrer">Bài 4.Tính kế thừa và Đa hình<ExternalLinkIcon/></a></th>
<th>🔜</th>
</tr>
</thead>
</table>
